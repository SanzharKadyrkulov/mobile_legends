...
const ProductComments = () => {
	...
	const sendComment = async (e, id, productos) => {
		...
		if (
			...
			await editProduct(id, productWithComment);
	...
	const deleteComment = async (index, id, productos) => {
		...
		await editProduct(id, productWithoutComment);
	...
	const editComment = async (index, id, productos) => {
		...
		await editProduct(id, productWithEditedComment);
	...
	return (
		<>
			{productDetails ? (
				<Paper
					style={{ backgroundImage: `url(${productDetails.animation})` }}
									...
									{product ? (
										product.comments.map((commentix, index) => (
											<div style={marginOfComment(commentix)}>
												...
												<div>
													<p style={{ color: '#e8c271', marginBottom: '2px' }}>
														{commentix.comment}
													</p>
												</div>
